...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class Viscous extends ShaderPass {
      ...
      updatePass(params: { viscous: number; iterations: number; dt: number }) {
        let fbo_out: any;
    ...
    class Simulation {
      ...
      createShaderPass() {
        ...
        this.pressurePass = new PressurePass({ cellScale: this.cellScale, boundarySpace: this.boundarySpace, src_p: this.fbos.pressure_0, src_v: this.fbos.vel_viscous0, dst: this.fbos.vel_0, dt: this.options.dt });
      }
      calcSize() {
      ...
      update() {
        ...
        if (this.options.isViscous) {
          vel = this.viscousPass.updatePass({ viscous: this.options.viscous, iterations: this.options.iterations_viscous, dt: this.options.dt });
        }
