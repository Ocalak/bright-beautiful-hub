...
const translations = {
  en: {
    ...
    proj4Details: "Evaluated multiple time-series forecasting models for Bitcoin price prediction.|Implemented ARIMA, GARCH, and LSTM neural network models in Python and R.|Performed comprehensive backtesting across different market conditions.|Analyzed model performance using MAE, RMSE, and directional accuracy metrics.|Explored feature engineering with trading volume, sentiment data, and technical indicators.|Published findings comparing model strengths in volatile vs. stable market periods.",
