...
const translations = {
  en: {
    ...
    otherProjectsTitle: "More Projects",
    otherProjectsSubtitle: "Additional work — experiments, client projects, and open-source contributions.",
    firstkebabTitle: "FirstKebab — Stripe Payment Integration",
    firstkebabDesc: "Integrated Stripe payments and automated webhook-driven email notifications for a restaurant website using vanilla JavaScript.",
    triviumTitle: "Sprachschule — AI SEO Automation",
    triviumDesc: "Built an LLM-powered SEO content workflow with Claude AI + Airtable, implemented hreflang for a bilingual site, and delivered a full technical SEO strategy.",
    aiWorkflowsTitle: "AI Automation Workflows — Claude + Airtable + n8n",
    aiWorkflowsDesc: "Production-style n8n workflows orchestrating Claude API and Airtable for scalable SEO content generation and support ticket triage.",
    voiceAgentTitle: "Praxis-AI-Suite — Local DSGVO AI for German Practices",
    voiceAgentDesc: "Two-app suite: waiting-room voice anamnesis on a tablet + public-website chatbot with RAG and appointment booking. All AI runs locally (Ollama, Whisper, bge-m3). tomedo GDT integration, full Art. 13 DSGVO compliance.",
  ...
  de: {
    ...
    otherProjectsTitle: "Weitere Projekte",
    otherProjectsSubtitle: "Zusätzliche Arbeiten — Experimente, Kundenprojekte und Open-Source-Beiträge.",
    firstkebabTitle: "FirstKebab — Stripe-Zahlungsintegration",
    ...
    voiceAgentTitle: "Praxis-AI-Suite — Lokale DSGVO-KI für deutsche Praxen",
    voiceAgentDesc: "Zwei-App-Suite: Wartezimmer-Sprachanamnese auf dem Tablet + öffentlicher Praxis-Chatbot mit RAG und Terminbuchung. Alle KI läuft lokal (Ollama, Whisper, bge-m3). tomedo-GDT-Integration, vollständige Art. 13 DSGVO-Konformität.",
