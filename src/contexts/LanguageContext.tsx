...
const translations = {
  en: {
    ...
    voiceAgentTitle: "Voice AI Intake Agent — Local STT/LLM/TTS Pipeline",
    voiceAgentDesc: "Local-first voice interview system: browser mic → Whisper STT → Ollama LLM → edge-tts — zero cloud APIs, GDPR-compliant medical intake.",
  ...
  de: {
    ...
    voiceAgentTitle: "Voice AI Intake Agent — Lokale STT/LLM/TTS-Pipeline",
    voiceAgentDesc: "Lokal-first Sprachinterviewsystem: Browser-Mikrofon → Whisper STT → Ollama LLM → edge-tts — ohne Cloud-APIs, DSGVO-konformes medizinisches Intake.",
